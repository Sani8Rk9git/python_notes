...
* These refer to the User-defined names given to different parts of the program.
...
3. Python is **case-sensitive** (it treats upper and lower case characters differently.)
