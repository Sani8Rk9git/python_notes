...
* We can also use single quotes(for display) in a string literal of double quotes and 

&#x20; double quotes in a string literal of single quotes.
...
&#x20;          -> The text will be displayed as it is written in the quotes (in multiple lines or
