...
&#x20;      Modulus operator %  -> produces the remainder by dividing the first operand by the second operand



**Python's // always goes to the left on the number line (toward −∞), never toward 0.**
